...
export const home = () => {
  ...
  I am a father and a student currently studying frontend development in HackYourFuture Belgium. <br>
  I'm enthusiastic about tech in coding and learning new things about computers and what they can do. </span>`;
